...
function init() {
	...
	console.log("-=" + _commonJsCommonJs.bannerSize.h);
	...
	tl.add("t2");
	tl.to(".phone_1a", { y: "-=" + _commonJsCommonJs.bannerSize.h, duration: .3 }, "t2");
	tl.from(".phone_1b", { y: "+=" + _commonJsCommonJs.bannerSize.h, duration: .3 }, "t2");
	tl.from(".t2", { opacity: 0, duration: .3 }, "t2");

	tl.from(".hero", { opacity: 0, duration: .3 }, "+=" + _commonJsCommonJs.read.t2);
	tl.from(".txt_uyg_big", { opacity: 0, y: "+=80", duration: .3 });
	tl.to(".txt_uyg_big", { opacity: 0, duration: .3 }, "+=1");
